...
const BookCard = ({Y,id,onDelete=()=>{},onEdit=()=>{},book={}}) =>{
    return(
            ...
            <button className='book-edit' onClick={()=>onEdit(book)}>Edit</button>
                ...
                <CardImg top height="100px" src={Y.image} alt="Card image cap" />
                <CardBody>
    ...
    const BookCardContainer = connect(null,mapDispatchToProps)(BookCard)
